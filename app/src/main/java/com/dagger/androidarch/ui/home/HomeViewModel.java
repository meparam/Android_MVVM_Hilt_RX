...
public class HomeViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<MenuModel>> allInboxList ;
    ...
    public MutableLiveData<ArrayList<MenuModel>> getAllInbox(){
    ...
    public void getCast() {
        disposables.add(repository.getAllMunu()
                .subscribeOn(Schedulers.io())
                .map(new Function<JsonArray, ArrayList<MenuModel>>() {
                    @Override
                    public ArrayList<MenuModel> apply(JsonArray jsonArray) throws Throwable {
                        //  JsonArray jsonArray = jsonObject.getAsJsonArray("cast");
                        Log.e("TAG", "apply: " );
                        return  new Gson().fromJson(jsonArray.toString(), new TypeToken<ArrayList<MenuModel>>(){}.getType());
                    }
                })
